...
while True:
    ...
    for i in range(0,random.randint(1,5)):
        wave_dict.append({"freq":random.randint(1,1000),"amp":random.randint(0,100)/100.0,"phase":random.randint(1,314)/100.0,"LFO_freq": random.randint(1,1000)/100.0,"LFO_phase":random.randint(1,314)/100.0,"LFO_F":random.randint(1,100)/100.0,"LFO_A":random.randint(1,100)/100.0,"LFO_P":random.randint(1,314)/100.0})
    input_array = []
